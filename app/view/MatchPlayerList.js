Ext.define("catcher.view.MatchPlayerList", {
    ...
    config : {
        ...
        store : "Players",
        itemTpl : "<div style=\"{[values.player_id==2147483647?\"font-style:italic; font-size:smaller;\":\"\"]} {[values.player_id==0?\"font-style:italic; font-size:smaller;\":\"\"]}\"><strong>#{number}</strong> {nick} <small>({surname} {name})</small></div>",        
        ...
        listeners : {
            ...
            painted : function(){
              ...
              if(this.getId() == "MatchPlayerListScore"){
                if(session.assist_player_id>0 && session.assist_player_id<2147483647){          
                  ...
                  if(typeof asistujici != "undefined") list.getItemAt(asistujici).hide();          
                }
              }
            ...
            deactivate : function(){              
              ...
              // if(this.getId() == "MatchPlayerListScore") {
              //   this.getItemAt(asistujici).hide();
