Ext.define("catcher.view.HelpPanel", {
    ...
    config : {
        ...
        html : [
                ...
                "<li>Nesprávně zadané zápasy lze smazat přejetím (swipe) prstem zprava doleva v seznamu zápasů",
                "</ul>",
                ...
                "<li>Nového nelze přidat v aplikaci, každý hráč by měl být v Evidenci ČALD. Pokud tam není, jeho body lze skórovat pouze jako Anonymní</li>",
                "</ul>",
                ...
                "<li>Výstup z aplikace (průběhy zápasů) jsou k dispozici na www.frisbee.cz/online-vysledky.html</li>", "</ul>" ]
                .join("")
    }
});